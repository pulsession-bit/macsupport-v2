...
export const Login: React.FC<LoginProps> = ({ onLoginSuccess, onCancel, showCancel }) => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-black p-0 lg:p-8 font-sans">
      <div className="w-full h-full lg:max-w-[1200px] lg:min-h-[85vh] bg-black lg:border lg:border-white/10 lg:rounded-[2.5rem] lg:shadow-2xl flex flex-col items-center justify-center relative overflow-hidden p-8 lg:p-20">
        ...
        <div className="w-full max-w-md flex flex-col items-center text-center animate-in fade-in zoom-in duration-500">
           ...
           <div className="mb-8 lg:mb-12">
              ...
              <p className="text-neutral-500 text-[10px] font-bold uppercase tracking-[0.5em]">{isRegistering ? 'Nouveau Compte' : 'Accès Authentifié'}</p>
           </div>
           ...
           <form onSubmit={handleAuth} className="w-full space-y-4">
              ...
              <div className="pt-4 space-y-4">
                 <button 
                    disabled={isLoading}
                    className="w-full py-6 bg-white text-black rounded-full font-bold uppercase tracking-[0.3em] text-[11px] hover:scale-[1.02] active:scale-[0.98] transition-all shadow-[0_0_40px_rgba(255,255,255,0.1)] disabled:opacity-50"
                 >
                 ...
                 <div className="relative py-4">
                    ...
                    <div className="relative flex justify-center text-[8px] font-bold uppercase tracking-[0.4em]"><span className="bg-black px-4 text-neutral-600">ou</span></div>
                 </div>
                 ...
                 <button 
                    ...
                    disabled={isLoading}
                    className="w-full py-5 bg-transparent border border-white/10 text-white rounded-full font-bold uppercase tracking-[0.3em] text-[10px] hover:bg-white/5 active:scale-[0.98] transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                 >
                 ...
                 <button 
                    ...
                    disabled={isLoading}
                    className="w-full py-3 bg-transparent border border-white/5 text-neutral-500 rounded-full font-bold uppercase tracking-[0.3em] text-[9px] hover:bg-white/5 hover:text-white transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                 >
           ...
           <div className="mt-10 flex flex-col items-center gap-4">
              ...
              <button 
                ...
                className="px-8 py-3 bg-white/5 border border-white/10 text-white rounded-full text-[9px] font-bold uppercase tracking-[0.3em] hover:bg-white/10 hover:border-white/20 transition-all active:scale-95"
              >
